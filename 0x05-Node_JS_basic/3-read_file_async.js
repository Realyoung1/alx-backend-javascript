/**
 * countStudents: counting the nubs of stds in each cates
 * with data read from a database file asynchronously.
 */
const fs = require('fs');

/**
 * readData: reading the data and counting the
 * numbs of studs in each field.
...
/**
 * countStudents - Reading files asynchronously.
